        ...
        <div class="top-info--left">
          <el-form :label-position="'right'" label-width="150px" :model="ruleForm">
            ...
            <el-form-item label="任务编号">
              <el-input readonly size="mini" v-model="upLoadData.serviceId"></el-input>
            </el-form-item>
        ...
        <div class="top-info--right">
          <div id="video" style="margin:0 auto;">
            <div
              v-if="status"
              id="agora_remote"
              style="margin:0 10px 10px;width:800px;height:500px;display:inline-block;background:	#F0FFFF;overflow:hidden"
            ></div>
            <div
              v-if="type == 'hasSupport'"
              style="margin:0 10px 10px;width:800px;height:500px;display:inline-block;background:	#F0FFFF;overflow:hidden"
            >
              <video
            ...
            <div
              ...
              style="margin:0 10px 10px;width:800px;height:500px;text-align:center;font-size:40px;line-height:500px;display:inline-block;background:	#F0FFFF"
            >见问题描述</div>
          </div>
          ...
          <el-container v-if="!status" class="container-border">
            <el-aside width="500px">
              <el-form-item label="片区经理(回复)">
                <!-- <message-show-list v-if="type == 'hasSupport'" :list="manageMessageList"/> -->
                <el-input
                  type="textarea"
                  :rows="8"
                  size="mini"
  ...
  methods: {
    ...
    getDataInfo() {
      console.log(
        ...
        typeof this.problemFeedbackTaskId
      );
      this.$axios
        .post(
          `${this.api}/onSiteService/${
            ...
            this.problemFeedbackTaskCode
              ? this.problemFeedbackTaskCode
              : this.$route.query.taskCode
          }&taskId=${
            this.problemFeedbackTaskId != "null" &&
            this.problemFeedbackTaskId != null
