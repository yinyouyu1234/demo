    ...
    <el-dialog width="600px" title="编辑" :close-on-click-modal="false" :visible.sync="innerVisible">
      ...
      >
        ...
        <el-form-item label="巡检类别" prop="name">
          <el-select
            size="mini"
            v-model="ruleFormItem.inspecting_type"
            @change="handleChange"
            placeholder="请选择"
          >
            <el-option
...
export default {
  ...
  methods: {
    ...
    uploadVideoSuccess(response, file, fileList) {
      console.log(this.step_detail_item);
      if (this.step_detail_item.videos) {
        this.step_detail_item.videos.push({
          name: file.name,
          url: file.response.data
        });
        // this.step_detail_item.videosList.push([
        //   {
        //     name: file.name,
        //     url: file.response.data
        //   }
        ...
        // this.step_detail_item.videosList = [
        //   {
        //     name: file.name,
        //     url: file.response.data
        //   }
    ...
    submitTreeEdit() {
      ...
      console.log(this.treeNode, item, this.activeRootData.steps);
    ...
    remove(node, data) {
      console.log(node, data, this.treeNode);
    ...
    submit(formName) {
      ...
      console.log(obj.guides[2].steps);
